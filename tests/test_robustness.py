...
class RobustnessTests(unittest.TestCase):
    ...
    def test_balance_ignores_negative_and_missing_credit_windows(self):
        data = {"limits": [{"unit": 3, "number": 5, "percentage": 50, "currentValue": 10, "usage": 4}]}
        self.assertIsNone(normalise_quota_limits(data)["credits"]["balance"])

        data = {"limits": [{"unit": 3, "number": 5, "percentage": 50, "currentValue": 4, "usage": 10}]}
    ...
    def test_normalisation_is_pure_in_the_seconds_domain(self):
        data = {"limits": [{"unit": 6, "number": 1, "percentage": 3, "nextResetTime": 1790064603989}]}
